...
bool CBlock::AcceptBlock()
{
    ...
    // Proof of Stake only after initial blocks.
    // Allow PoW on testnet for faster testing.
    // Otherwise only up to block 1000.
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        nStakeMaxAge = 20 * 60; // test net min age is 20 min
